...
abstract class MedicalExamineLocalDataSource {
...
class MedicalExamineLocalDataSourceImpl
    implements MedicalExamineLocalDataSource {
  final SharedPreferences sharedPreferences;

  MedicalExamineLocalDataSourceImpl({required this.sharedPreferences});
